...
# This helper script provides platform-detection facilities, so 
# that user scripts are freed from UNIX particularisms, or at least
# can take them into account more easily.
#
# Beyond testing whether the specific platform has been detected,
# the user script can test particular platform family 
...
# 			- Linux        (CEYLAN_ARCH_LINUX) : for all kinds of
# GNU/Linux distributions
# 			- Sun Solaris  (CEYLAN_ARCH_SOLARIS): for all various
# Solaris versions
#			- IBM AIX      (CEYLAN_ARCH_AIX): for all various AIX
# versions
#			- SGI IRIX     (CEYLAN_ARCH_IRIX): for all various IRIX
# versions
#			- HP UX        (CEYLAN_ARCH_HPUX): for all various HP-UX
# versions
...
# 			- Mac OS X (CEYLAN_ARCH_MACOSX): for all versions,
# including Panther and Tiger (10.4)
...
#	- CEYLAN_ARCH_UNIX_ON_WINDOWS = CEYLAN_ARCH_CYGWIN and
# CEYLAN_ARCH_MINGW
#	- CEYLAN_ARCH_POSIX = CEYLAN_ARCH_UNIX and
# CEYLAN_ARCH_UNIX_ON_WINDOWS
# Feature activation section (to integrate in configure).

# Architectures cannot be fully organized as a tree as, for example,
# POSIX compliance depends on the choice of Windows subplatforms. 
...
#	- CEYLAN_PROC_IA32 (x86),CEYLAN_PROC_IA64 (Itanium),
# CEYLAN_PROC_AMD64 (AMD), CEYLAN_PROC_POWERPC, CEYLAN_PROC_SPARC,
# CEYLAN_PROC_ALPHA
...
#
# Usage  : findTool <executable tool name> [<message if tool not found>]
# Example: 
# if findTool grep ; then
#   GREP=$returnedString
#   ...
{
