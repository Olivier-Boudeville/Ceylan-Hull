...
usage="Usage: $(basename $0) PROCESS_NAME_TO_KILL: kills all processes that match specified name pattern."

# This script only targets user-owned processes not corresponding to a text
# editor (root would not be able to kill another's user's processes)
